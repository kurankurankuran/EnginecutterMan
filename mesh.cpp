...
bool           g_bSaveMesh[MAX_SAVE_MESH];
MESH*         g_pSaveMesh[MAX_SAVE_MESH];
...
// メッシュデータ保存
//=============================================================================
void SaveMesh(MESH* pMesh)
{
	for (int i = 0; i < MAX_SAVE_MESH; i++) {
		if (g_bSaveMesh[i])continue;
...
// メッシュデータ初期化
//=============================================================================
void InitSaveMesh(void)
{
	for (int i = 0; i < MAX_SAVE_MESH; ++i) {
		g_pSaveMesh[i] = nullptr;
		g_bSaveMesh[i] = false;
	}
